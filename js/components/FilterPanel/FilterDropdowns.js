  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      showDivisionDropdown && React.createElement('div', {
        className: `absolute z-[9999] mt-1 w-full ${darkMode ? 'bg-slate-800 border-slate-600' : 'bg-white border-gray-200'} border rounded-lg shadow-xl max-h-60 overflow-y-auto dropdown-enter`,
    ...
    React.createElement('div', {
      ...
      showBPDropdown && React.createElement('div', {
        className: `absolute z-[9999] mt-1 w-full ${darkMode ? 'bg-slate-800 border-slate-600' : 'bg-white border-gray-300'} border rounded shadow-lg max-h-60 overflow-y-auto dropdown-enter`,
